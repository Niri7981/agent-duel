...
function mapSettlement(round: PersistedRoundRecord): RoundSettlement {
...
export function mapRoundToState(round: PersistedRoundRecord): RoundState {
  return {
    ...
    id: round.id,
    settlement: mapSettlement(round),
